...
#CFLAGS = -Wall -lrt
CFLAGS = -O3 -g -Wno-cpp -lrt -Wno-write-strings
...
#
MODULES   = adc.o qdc.o scaler.o SiliconData.o GammaData.o Parameters.o multiTDC.o MMM.o W1.o X1.o RawData.o HagarSort.o LEPS.o f-plane.o ame.o
...
CC = cc
CXX = g++
CFLAGS += -I$(INC_DIR) -I$(DRV_DIR) -I$(MODULES_DIR) -I$(VMEDRV_DIR)
LDFLAGS += -L $(LIB)
