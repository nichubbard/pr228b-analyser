...
Int_t    t_tof,t_toftdc2,t_toftdc3,t_toftdc4,t_toftdc5,t_toftdc6, t_toftdc7, t_toftdc8;
Int_t    t_k600;
Int_t    t_runtime=0;
...
void ZeroFPWireTimeDist(void)
{
   ...
   memset(&U1, 0, sizeof(X1));
   memset(&U2, 0, sizeof(X1));
}
...
void ZeroTTreeVariables(void)     // Really more an initialization as a zero-ing
{
   ...
   t_tof=0; t_toftdc2=0; t_toftdc3=0; t_toftdc4=0; t_toftdc5=0; t_toftdc6=0; t_toftdc7=0; t_toftdc8=0;
...
// 	   setupchannel2wireXoldXold();
  ...
  t1->Branch("toftdc8",&t_toftdc8,"t_toftdc8/I");
...
//   printf("L2218\n");
   ...
   Int_t reftimes[8]; 
   Int_t tof=0,toftdc2=0,toftdc3=0,toftdc4=0,toftdc5=0,toftdc6=0,toftdc7=0, toftdc8=0;
...
//   if(PaddlePIDGatesFlagb==1){    //only keep analyzer busy with events that pass this rough cut
   ...
   for(int i = 0; i < ntdc; i++) {
	...
	printf("bad tdc module nr %d\n",tdcmodule);   // error condition - not changed this for the PR228B stuff because I think that it's still OK.
      }
	...
	hTDC2DModule[tdcmodule]->Fill(ref_time,channel); 
      ...
      switch(channel){
		...
		case (TOF_TDC_CHAN+6*128): if(t_toftdc7==0) toftdc7=ref_time; t_toftdc7=toftdc7; break;
                case (TOF_TDC_CHAN+7*128): if(t_toftdc8==0) toftdc8=ref_time; t_toftdc8=toftdc8; break;
