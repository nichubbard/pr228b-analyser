...
// Fri Oct 24 14:27:56 2014 by ROOT version 5.34/11
// from TTree DATA/K600 data
// found on file: run00035.root
//////////////////////////////////////////////////////////
...
class Calibrate : public TSelector {
public :
 ...
 //RawData         *RawInfo;
   ...
   Calibrate(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~Calibrate() { }
   ...
   ClassDef(Calibrate,0);
};

#endif

#ifdef Calibrate_cxx
void Calibrate::Init(TTree *tree)
{
