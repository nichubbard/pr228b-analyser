...
// The class definition in Pedestals.h has been generated automatically
...
//
// Root > T->Process("Pedestals.C")
// Root > T->Process("Pedestals.C","some options")
// Root > T->Process("Pedestals.C+")
//
...
Bool_t Pedestals::Process(Long64_t entry)
{
   ...
   // It can be passed to either Pedestals::GetEntry() or TBranch::GetEntry()
   ...
   {
      adcs[i]->Fill(ADCValues[i]);
   }

   return kTRUE;
}

void Pedestals::SlaveTerminate()
{
